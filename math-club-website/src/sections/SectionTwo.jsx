    ...
    return (
        <Box sx={{ backgroundColor: '#32006e', alignItems: 'center', textAlign: "center", paddingX: {xs: 4, sm: 6, md: 8}, paddingY: {xs: 6, sm: 8, md: 10} }}>
            ...
            <Typography variant="h5" sx={{ fontSize: "clamp(0.75rem, 2.75vw, 2.25rem)", color: "#ffffff", mt: {xs: 4, sm: 6, md: 8}}}>
                Congratulations To Our 2026 Integration Bee Event Winners!
            </Typography>
            ...
            <Grid container spacing={2} justifyContent="center" alignItems={"center"} sx={{mt: {xs: 3, sm: 4, md: 5}}}>
                ...
                <Grid size={6} textAlign={"center"}>
                    ...
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 1.50vw, 1.50rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Winner</Typography>
                </Grid>
                ...
                <Grid size={6} textAlign={"center"}>
                    ...
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 1.50vw, 1.50rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Winner + Runner Up</Typography>
                </Grid>
