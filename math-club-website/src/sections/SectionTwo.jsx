...
export default function SectionTwo() {
    return (
        <Box sx={{ backgroundColor: '#32006e', alignItems: 'center', textAlign: "center", paddingX: {xs: 4, sm: 6, md: 8}, paddingY: {xs: 6, sm: 8, md: 10} }}>
            ...
            <Typography variant="h5" sx={{ fontSize: "clamp(0.25rem, 2.75vw, 2.5rem)", color: "#ffffff", mt: {xs: 4, sm: 6, md: 8}}}>
            ...
            <Typography variant="h5" sx={{ fontSize: "clamp(1.25rem, 3.50vw, 2.75rem)", color: "#ffffff", mt: {xs: 4, sm: 6, md: 8}}}>
            ...
            <Grid container spacing={2} justifyContent="center" alignItems={"center"} sx={{mt: {xs: 6, sm: 8, md: 10}}}>
                <Grid size={4} textAlign={"center"}>
                    ...
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 2.25vw, 2.0rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Husky Math Talk Event</Typography>
                </Grid>

                 <Grid size={4} textAlign={"center"}>
                    <img src={event_2_pic} style={{ width: "75%" }} />
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 2.25vw, 2.0rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Husky Estimathon Event</Typography>
                </Grid>

                 <Grid size={4} textAlign={"center"}>
                    <img src={event_3_pic} style={{ width: "75%" }} />
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 2.25vw, 2.0rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Annual Integration Bee</Typography>
                </Grid>

            </Grid>

            <Typography variant="h5" sx={{ fontSize: "clamp(0.75rem, 2.75vw, 2.25rem)", color: "#ffffff", mt: {xs: 4, sm: 6, md: 8}}}>
                Congratulations To Our Previous Integration Bee Winners!
            </Typography>
            ...
            <Grid container spacing={2} justifyContent="center" alignItems={"center"} sx={{mt: {xs: 6, sm: 8, md: 10}}}>
                ...
                <Grid size={6} textAlign={"center"}>
                    ...
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 2.25vw, 2.0rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Our Winner</Typography>
                </Grid>
                ...
                <Grid size={6} textAlign={"center"}>
                    ...
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.15rem, 2.25vw, 2.0rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>First + Second Place</Typography>
                </Grid>
