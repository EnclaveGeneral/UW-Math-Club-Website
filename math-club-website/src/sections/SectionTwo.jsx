        ...
        <Box sx={{ backgroundColor: '#32006e', alignItems: 'center', textAlign: "center", paddingX: {xs: 4, sm: 6, md: 8}, paddingY: {xs: 6, sm: 8, md: 10} }}>
            ...
            <Grid container spacing={2} justifyContent="center" alignItems={"center"} sx={{mt: {xs: 6, sm: 8, md: 10}}}>
                <Grid size={4} textAlign={"center"}>
                    ...
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.25rem, 2.75vw, 2.5rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Husky Math Talk Event</Typography>
                </Grid>

                 <Grid size={4} textAlign={"center"}>
                    <img src={event_2_pic} style={{ width: "75%" }} />
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.25rem, 2.75vw, 2.5rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Husky Estimathon Event</Typography>
                </Grid>

                 <Grid size={4} textAlign={"center"}>
                    <img src={event_3_pic} style={{ width: "75%" }} />
                    <Typography variant="h6" sx={{ fontSize: "clamp(0.25rem, 2.75vw, 2.5rem)", color: "#ffffff", fontStyle: "italic", mt: {xs: 0.5, sm: 1.0, md: 1.5}}}>Annual Integration Bee</Typography>
                </Grid>
